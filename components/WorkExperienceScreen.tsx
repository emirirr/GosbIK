...
const WorkExperienceScreen: React.FC<Props> = ({ onBack }) => {
  const [title, setTitle] = useState('Grafik Tasarım');
  const [company, setCompany] = useState('Nakkaş Prodüksiyon');
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>İş Deneyimi</Text>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.label}>İş Ünvanı</Text>
        ...
        <TouchableOpacity style={styles.checkboxRow} onPress={() => setCurrent(!current)}>
          ...
          <Text style={styles.checkboxLabel}>Şuanda Burada Çalışıyorum</Text>
        </TouchableOpacity>
...
// Same calendar as AboutMeScreen (tabs + month grid)
